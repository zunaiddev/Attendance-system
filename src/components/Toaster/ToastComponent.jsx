...
function ToastComponent({message, icon, fill, end}) {
    ...
    return (
        <div
            className={`flex items-center max-w-xs p-4 rounded-lg shadow-sm text-white bg-gray-800 animate-slide ${animate && 'transform -translate-y-[110%] opacity-0 duration-500 ease-out'}`}
            role="alert">
