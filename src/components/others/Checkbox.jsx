...
function Checkbox({text, link, to, register, errors, className, onChange}) {
    return (
        <div className={`flex items-start mb-6 pl-1 ${className}`}>
            <div className="flex items-center h-5">
                <input id="remember" type="checkbox" value="" onChange={onChange}
