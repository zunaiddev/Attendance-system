...
function PopupModel({message, desc, onSubmit, onClose, custom, buttonText}) {
    return (
        <div
            className={`flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-99 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-gray-500/30 backdrop-blur-sm`}>
